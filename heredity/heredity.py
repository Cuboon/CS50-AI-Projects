    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            if genes == 2:
                ...
                prob_gene = mom * (1 - dad) + dad * (1 - mom)
            else:
                prob_gene = (1 - mom) * (1 - dad)
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        #normalize gene_propability
        genes_all = sum(probabilities[person]["gene"].values())
        for gene in probabilities[person]["gene"]:
            probabilities[person]["gene"][gene] /= genes_all

        #normalize trait_propability
        traits_all = sum(probabilities[person]["trait"].values())
        for gene in probabilities[person]["trait"]:
            probabilities[person]["trait"][gene] /= traits_all
